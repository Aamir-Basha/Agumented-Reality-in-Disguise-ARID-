...
# BLE / UART Setup aus dem offiziellen Repo.
# NICHT BEARBEITEN
# Kanäle sind hardwaregebunden (GPIO)
# Unser Programm nutzt nicht alle gegebenen Funktionen.
# Schreibt Funktionen am besten mit get_all_data(), send_command() und send_data()

# Beschreibung:
# Wird ein Event gestartet, so sucht unser Client nach den beworbenen Kanälen der hinterlegten Monocle.
# Es gibt 2 reciever und 2 transmission Kanäle, ein paar für Dienste und eins für Daten.
# Mit send_command() können der MCU Anweisungen gegeben werden, welche diese mit ihren eigenen Bibliotheken
# ausführt.
...
class Monocle:
    ...
    # async def heartbeat(self):
        ...
        # try:
            # await self.client.connect()
        #     await self.client.write_gatt_char(0x1234, b"PING")
        #     await asyncio.sleep(5)  # Adjust the interval as needed
        # except bleak.BleakError:
        #     return 1
            # print("Device disconnected. Reconnecting...")
            # Handle reconnect logic here (e.g., retry connection)
